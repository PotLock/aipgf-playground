...
const getNetworkId = () => process.env.NEXT_PUBLIC_NETWORK_ID === "mainnet" ? "mainnet" : "testnet";
const getRelayerAccountId = () => process.env.NEXT_PUBLIC_NETWORK_ID === "mainnet" ? process.env.NEXT_PUBLIC_RELAYER_ACCOUNT_ID_NEAR_MAINNET : process.env.NEXT_PUBLIC_RELAYER_ACCOUNT_ID_NEAR_TESTNET;
const getRelayerPrivateKey = () => process.env.NEXT_PUBLIC_NETWORK_ID === "mainnet" ? process.env.RELAYER_PRIVATE_KEY_NEAR_MAINNET : process.env.RELAYER_PRIVATE_KEY_NEAR_TESTNET;
const getRpc = () => process.env.NEXT_PUBLIC_NETWORK_ID == "mainnet" ? process.env.RPC_MAINNET : process.env.RPC_TESTNET;
